...
# 👇 Ensure you add this to your hyprland.conf manually or via this script:
...
echo "Applying Kvantum Catppuccin theme..."
# Already installed kvantum-theme-catppuccin-git
...
echo "Make sure your Hyprland config includes:"
